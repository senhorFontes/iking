...
<ul id="header_links">
	...
	<li id="header_link_sitemap" {if $page_name=='sitemap'}class="active"{/if}><a href="{$link->getPageLink('sitemap')}" title="{l s='sitemap' mod='blockpermanentlinks'}"  >{l s='Sitemap' mod='blockpermanentlinks'}</a></li>
