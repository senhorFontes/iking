...
class CsSlider extends Module
{
	...
	public function init_data()
	{
		...
		!Db::getInstance()->Execute('INSERT INTO `'._DB_PREFIX_.'csslider_lang` (`id_slider`, `id_lang`, `image`, `caption`) VALUES ( "1", "1","1_1.png", "")') OR
		!Db::getInstance()->Execute('INSERT INTO `'._DB_PREFIX_.'csslider_lang` (`id_slider`, `id_lang`, `image`, `caption`) VALUES ( "1", \''.$id_fr.'\',"1_1.png", "")') OR
		!Db::getInstance()->Execute('INSERT INTO `'._DB_PREFIX_.'csslider_lang` (`id_slider`, `id_lang`, `image`, `caption`) VALUES ( "1", "3","1_1.png", "")') OR
		!Db::getInstance()->Execute('INSERT INTO `'._DB_PREFIX_.'csslider_lang` (`id_slider`, `id_lang`, `image`, `caption`) VALUES ( "2", "1","2_1.png", "")') OR
		!Db::getInstance()->Execute('INSERT INTO `'._DB_PREFIX_.'csslider_lang` (`id_slider`, `id_lang`, `image`, `caption`) VALUES ( "2", \''.$id_fr.'\',"2_1.png", "")') OR
		!Db::getInstance()->Execute('INSERT INTO `'._DB_PREFIX_.'csslider_lang` (`id_slider`, `id_lang`, `image`, `caption`) VALUES ( "2", "3","2_1.png", "")') OR
		!Db::getInstance()->Execute('INSERT INTO `'._DB_PREFIX_.'csslider_lang` (`id_slider`, `id_lang`, `image`, `caption`) VALUES ( "3", "1","3_1.png", "")') OR
		!Db::getInstance()->Execute('INSERT INTO `'._DB_PREFIX_.'csslider_lang` (`id_slider`, `id_lang`, `image`, `caption`) VALUES ( "3",\''.$id_fr.'\',"3_1.png", "")') OR
		!Db::getInstance()->Execute('INSERT INTO `'._DB_PREFIX_.'csslider_lang` (`id_slider`, `id_lang`, `image`, `caption`) VALUES ( "3", "3","3_1.png", "")')
		)
		return false;
		return true;
	}
		...
		if (is_array($sliders))
		{
			...
			foreach ($sliders as $slider)
			{
				if ($dot_pos = strrpos($slider['image'],'.'))
					...
					$thumb_url =_PS_BASE_URL_._MODULE_DIR_.$this->name.'/image/default_thumb.png';
				$this->_html .= '
